# Generated by Django 3.2.6 on 2021-10-11 17:08
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Schedule',
            fields=[
                ('id_agenda', models.CharField(db_column='Sch_Id', max_length=250, primary_key=True, serialize=False)),
                ('dataagenda', models.DateTimeField(blank=True, db_column='App_DtTm', null=True)),
                ('id_paciente', models.CharField(blank=True, db_column='Pat_ID1', max_length=250, null=True)),
